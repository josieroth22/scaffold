...
- **Cite verified admit rates as the baseline.** When writing admission probability, always state the verified overall admit rate first (e.g., "Emory's overall admit rate is 10.3% per CDS 2024-25"), then give your adjusted estimate for this student. Do not skip the baseline number.
