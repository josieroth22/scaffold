...
7. **Budget alignment:** Does the family's stated budget appear prominently in your financial analysis? For EVERY school, did you compare the estimated net cost to the budget? Are over-budget schools clearly flagged in the executive summary table (e.g., "over budget" in the financial risk column)? CRITICAL: If more than half the schools on your list exceed the family's budget, your list is wrong. Go back and replace some over-budget schools with affordable options. Every list must include at least 2-3 schools that are confidently UNDER budget even without merit aid. A family with a $30K budget should not see a list where 10/12 schools cost $40-90K.
...
- \`admit_pct\`: your admission probability estimate for this student as a decimal (0 to 1), same as in the table. Use FULL PRECISION to match your narrative: if you wrote "3.6%" then use 0.036, NOT 0.03. If you wrote "27.3%" then use 0.273, NOT 0.27. Round to 3 decimal places minimum.
