...
Then generate each of these sections. Each should stand alone so a parent can jump to "Essay Strategy" in year 3 without reading anything else. Capitalize month names and abbreviations everywhere, including in tables and timelines ("Nov 1", "Aug-Sept", "early January"). When stating the student's age, write it out ("16 years old"), never a bare number:
